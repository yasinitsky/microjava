...
function(set_toolchain toolchain_prefix)
    ...
    find_program(MICROJAVA_CXX_COMPILER ${toolchain_prefix}-g++)
    if(${MICROJAVA_CXX_COMPILER} STREQUAL "MICROJAVA_CXX_COMPILER-NOTFOUND")
    ...
    set(CMAKE_CXX_COMPILER ${MICROJAVA_CXX_COMPILER} CACHE FILEPATH "")
endfunction()